...
CASES = {
    'baseline': dict(east=1.2, north=4., trigger_north=.8, expected='goal'),
    'west': dict(east=1., north=4., trigger_north=.8, expected='goal'),
    'later': dict(east=1.2, north=4., trigger_north=1.15, expected='goal'),
    'no_path': dict(east=1.2, north=5., trigger_north=.8, expected='safe_rejection'),
}
