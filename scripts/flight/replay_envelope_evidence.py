...
def replay(out):
    ...
    inputs=[journal,out/'protocol.json',Path(__file__).resolve(),Path('src/flight/envelope_route.py').resolve(),Path('src/flight/live_obstacle_map.py').resolve()]+snapshots
