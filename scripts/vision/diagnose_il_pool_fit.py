...
from scripts.vision.interleaved_light_control import OUT as TRAIN,KEYS,prior
from scripts.vision.evaluate_interleaved_light import protocol,configure,adapter
configure()
