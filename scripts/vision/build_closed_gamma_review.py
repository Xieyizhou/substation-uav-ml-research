...
from scripts.vision.evaluate_closed_gamma import OUT,KEYS,prior,validate_record
...
def main():
    ...
    _,p,_=__import__('scripts.vision.evaluate_closed_gamma',fromlist=['contract']).contract(KEYS[0])
