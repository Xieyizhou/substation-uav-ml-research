...
from scripts.vision.build_closed_budget_review import DEST, prior
from scripts.vision.closed_budget_observations import OBS
...
def main():
    ...
    validate(e, ds)
    paths = [ep, Path(__file__).resolve(), Path(__file__).with_name('closed_budget_observations.py')]
