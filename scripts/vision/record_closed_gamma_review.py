...
from scripts.vision.build_closed_gamma_review import DEST, prior
from scripts.vision.closed_gamma_observations import OBS
...
def main():
    ...
    validate(e, ds)
    paths = [ep, Path(__file__).resolve(), Path(__file__).with_name('closed_gamma_observations.py')]
