...
from scripts.vision.review_neutral_gray_errors import DEST,prior
from scripts.vision.neutral_gray_error_notes import parse
...
def main():
    ...
    validate(e,ds)
    deps=[ep,Path(__file__).resolve(),Path(__file__).with_name('neutral_gray_error_notes.py')]
