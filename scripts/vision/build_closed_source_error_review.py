...
from scripts.vision.evaluate_closed_source_control import OUT,KEYS,prior,validate_record
...
def main():
    ...
    _,p,_=__import__('scripts.vision.train_closed_source_control',fromlist=['contract']).contract(KEYS[0])
