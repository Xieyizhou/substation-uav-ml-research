...
from scripts.vision.build_bn_review import DEST,prior
from scripts.vision.bn_review_observations import parse
...
def main():
    ...
    validate(e,ds)
    deps=[ep,Path(__file__).resolve(),Path(__file__).with_name('bn_review_observations.py')]
