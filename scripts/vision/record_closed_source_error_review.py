...
from scripts.vision.build_closed_source_error_review import DEST, prior
...
def main():
    ...
    validate(e, ds)
    paths = [ep, Path(__file__).resolve(), Path(__file__).with_name('closed_source_error_observations.py')]
