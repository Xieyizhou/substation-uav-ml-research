...
from scripts.vision.evaluate_closed_budget import OUT,KEYS,prior,validate_record
...
def main():
    ...
    _,p,_=__import__('scripts.vision.evaluate_closed_budget',fromlist=['contract']).contract(KEYS[0])
