...
from scripts.vision.build_physical_low_light_review import DEST, prior
from scripts.vision.physical_light_error_observations import OBS
...
def main():
    ...
    validate(e, ds)
    paths = [ep, Path(__file__).resolve(), Path(__file__).with_name('physical_light_error_observations.py')]
