...
from scripts.vision.cool_light_control import OUT,REF,KEYS,prior
        ...
        for group in (KEYS[:2],KEYS[2:]):
            ...
            try:
                for key in group:
                    ...
                    proc=subprocess.Popen([sys.executable,'-u','-m','scripts.vision.evaluate_cool_light','--cell',key,'--evaluate'],cwd=prior.ROOT,stdout=log,stderr=subprocess.STDOUT,start_new_session=True)
