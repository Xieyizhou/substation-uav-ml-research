...
from scripts.vision.build_material_retention_review import DEST, prior
...
def main():
    ...
    validate(e, ds)
    paths = [ep, Path(__file__).resolve(), Path(__file__).with_name('material_retention_review_observations.py')]
