...
from scripts.vision.evaluate_material_late_rehearsal import OUT,KEYS,prior,validate_record,low_dose
...
def main():
    ...
    _,p,_=__import__('scripts.vision.train_material_late_rehearsal',fromlist=['contract']).contract(KEYS[0])
