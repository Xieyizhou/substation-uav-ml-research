...
from scripts.vision.train_material_fixed_sequence_lr import OUT, KEYS, complete, contract, prior
...
def finish():
    ...
    for seed in (7,17,27):
        key=f'Q-{seed}';complete(key);ep=OUT/'evaluation'/f'{key}.json'
    ...
    return prior.frozen(dest,dict(status='numerical_complete_explicit_error_review_pending',
        ...
        comparison='Q versus T: same sequence and brightness, constant learning rate 0.00025 versus 0.0005.',
