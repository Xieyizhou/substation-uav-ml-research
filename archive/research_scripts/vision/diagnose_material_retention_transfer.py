...
from scripts.vision.train_material_retention_coverage import OUT as TRAIN, KEYS, contract, complete
from scripts.vision.diagnose_gray_body_transfer import OUT as PREVIOUS
...
def freeze():
    ...
    return prior.frozen(dest,dict(status='six_endpoint_same_source_diagnosis_frozen',
