...
from scripts.vision.evaluate_gray_body_control import OUT,KEYS,prior,validate_record,low_dose
...
def main():
    ...
    _,p,_=__import__('scripts.vision.train_gray_body_control',fromlist=['contract']).contract(KEYS[0])
