...
from scripts.vision.record_material_retention_review import DEST, prior, validate
...
def main():
    ...
    result=prior.frozen(DEST/'review-summary.json',dict(status='reviewed_error_inventory_with_content_gaps',
        ...
        limits=['Source pose grouping is not pixel overlap or asset-identity certification',
                ...
                'Comparison/seed loss events share 84 unique truth targets; neither count is independent scene count',
