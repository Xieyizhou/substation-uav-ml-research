...
from scripts.vision.preflight_cool_light import preflight
from scripts.vision.train_cool_light import contract

TESTS = ('tests.test_cool_light_capture', 'tests.test_cool_light_control',
