...
from scripts.vision.build_same_source_material_dose_review import DEST, prior
...
def main():
    ...
    validate(e, ds)
    paths = [ep, Path(__file__).resolve(), Path(__file__).with_name('same_source_material_dose_observations.py')]
