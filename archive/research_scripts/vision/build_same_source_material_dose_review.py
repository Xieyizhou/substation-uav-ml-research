...
from scripts.vision.evaluate_same_source_material_dose import OUT,KEYS,prior,validate_record,low_dose
...
def main():
    ...
    _,p,_=__import__('scripts.vision.train_same_source_material_dose',fromlist=['contract']).contract(KEYS[0])
