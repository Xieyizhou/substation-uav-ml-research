...
from scripts.vision.build_gray_body_error_review import DEST, prior
...
def main():
    ...
    validate(e, ds)
    paths = [ep, Path(__file__).resolve(), Path(__file__).with_name('gray_body_review_observations.py')]
