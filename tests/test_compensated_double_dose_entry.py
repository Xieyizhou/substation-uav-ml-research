...
import torch
from scripts.vision.train_compensated_double_dose import BatchGate,main,tensor_hash
...
class EntryTests(unittest.TestCase):
    ...
    def test_default_never_trains(self):
        with patch('scripts.vision.train_compensated_double_dose.ready') as ready,patch('scripts.vision.train_compensated_double_dose.run',side_effect=AssertionError('Training')):
