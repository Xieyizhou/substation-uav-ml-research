...
import torch
from scripts.vision.train_material_retention_coverage import BatchGate,main,tensor_hash
...
class EntryTests(unittest.TestCase):
    ...
    def test_default_never_trains(self):
        with patch('scripts.vision.train_material_retention_coverage.ready') as ready,patch('scripts.vision.train_material_retention_coverage.run',side_effect=AssertionError('Training')):
