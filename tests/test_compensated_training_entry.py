...
import torch
from scripts.vision.train_compensated_material import BatchGate,main,tensor_hash
...
class EntryTests(unittest.TestCase):
    ...
    def test_default_never_trains(self):
        with patch('scripts.vision.train_compensated_material.ready') as ready,patch('scripts.vision.train_compensated_material.run',side_effect=AssertionError('Training')):
