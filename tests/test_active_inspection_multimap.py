...
from scripts.flight.aggregate_active_inspection_matrix import identity, truth_from_obstacles
...
class ActiveInspectionMultimapTests(unittest.TestCase):
    def test_truth_adapter_normalizes_classes_and_centers(self):
        ...
        self.assertEqual(truth, [{"id": "c1", "class_name": "capacitor_bank", "east_m": 4, "north_m": 6}])
