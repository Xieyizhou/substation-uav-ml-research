...
from src.vision.collection.pilot_acceptance import validate_v3_acceptance_policy
...
def load_pilot_protocol(path=DEFAULT_PROTOCOL):
    from src.vision.collection.pilot import PilotRecordingError, _read_json
...
def validate_mission_events(events):
    from src.vision.collection.pilot import PilotRecordingError
